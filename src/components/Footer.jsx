        ...
        <div className="footer-container">
          <div className="footer-column">
            ...
            <div className="social-icons">
              <a href="https://www.instagram.com/demadose/" className="social-icon" aria-label="Instagram">
              ...
              <a href="https://www.linkedin.com/company/demadose/posts/?feedView=all" className="social-icon" aria-label="LinkedIn">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
